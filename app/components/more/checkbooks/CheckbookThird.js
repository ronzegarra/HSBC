...
export default class CheckbookThird extends PureComponent {
  constructor(props) {
    super(props);
  ...
  goNext() {
    this.props.navigation.navigate('Chequera_Cuarta');
  }
  goBack() {
          ...
          <View style={{ marginTop: 10, marginLeft: 1, marginRight: 1 }}>
            ...
            >
              ...
              >
                ...
                <Text style={{ fontSize: 13, paddingLeft: 10 }}>10</Text>
                ...
                <Text style={{ fontSize: 13, paddingLeft: 10 }}>$40.75</Text>
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'center',
