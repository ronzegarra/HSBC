...
export default class CheckbookItem extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  viewMore(item) {
    if (item.Type === 'CC') this.props.navigation.navigate('Chequera_Segunda');

    if (item.Type === 'CA') this.props.navigation.navigate('Chequera_Segunda');
  }
