...
export default class TransferenceOtherBanksSecond extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
                  ...
                  >
                    ...
                    >
                      ...
                      <Switch
                        onValueChange={value =>
                          this.setState({
                            schedulleTransfer: value
                          })
                        }
                        onTintColor={theme.colorPrincipal}
                        thumbTintColor="#FFFFFF"
                        tintColor="#EEEEED"
                        value={this.state.schedulleTransfer}
                        style={{ marginBottom: 0 }}
                      />
                    </View>
                  </View>
                  {this.state.schedulleTransfer ? (
                    <View
                      style={{
                        flexDirection: 'row',
                        justifyContent: 'flex-start',
