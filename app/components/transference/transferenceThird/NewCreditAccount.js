              ...
              >
                  ...
                  <View>
                    <View style={styles.picker}>
                      <Picker
                        ...
                        onValueChange={text => this.changeAccountType(text)}
                      >
                        <Picker.Item label="Seleccionar" value="" />
                        <Picker.Item label="Cuenta 1" value="cuenta1" />
                        <Picker.Item label="Cuenta 2" value="cuenta2" />
                      </Picker>
                    </View>
                  </View>
                </View>
                ...
                >
                  ...
                  >
                    ...
                    <Switch
                      onValueChange={value =>
                        this.setState({ agendaCuenta: value })
                      }
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Switch
                        onValueChange={value =>
                          this.setState({ notifyUser: value })
                        }
                        onTintColor={theme.colorPrincipal}
                        thumbTintColor="#FFFFFF"
                        tintColor="#EEEEED"
