...
export default class TransferenceThirdFifth extends PureComponent {
  constructor(props) {
    super(props);
  ...
  goNext() {
    this.props.navigation.navigate('Transferir');
  }
    ...
    return (
      <View>
        <ScrollView>
            ...
            <View style={{ width: '100%', position: 'absolute' }}>
              <View style={{ width: '100%', alignItems: 'center' }}>
                <View style={{ paddingTop: 15}}>
                  {/*<Image
                    source={require('../../../img/RecursosHSBC/Transferences/Ticket_Ok.png')}
          ...
          <View style={{ flexDirection: 'row', marginBottom: 15, top: -48 }}>
