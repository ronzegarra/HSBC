...
export default class PayServicesSubItem extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  renderImage(type) {
    switch (type) {
      case 'CC':
        return <Image source={require('../../../img/RecursosHSBC/Payments/Cartera.png')} resizeMode={'stretch'} style={styles.imageItem} />;
      case 'CA':
        return <Image source={require('../../../img/RecursosHSBC/Payments/Cartera.png')} resizeMode={'stretch'} style={styles.imageItem} />;
    }
  }
  ...
  viewMore(item) {
    this.props.navigation.navigate('PagarServicios_Tercera');
  }
