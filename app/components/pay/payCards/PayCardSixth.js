...
export default class PayCardSixth extends PureComponent {
  constructor(props) {
    super(props);
        ...
        <ScrollView>
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 13, paddingLeft: 10 }}>Oro Empres</Text>
              <Text style={{ fontSize: 14, fontWeight: '600', color: 'black' }}>
                Tipo de Pago
              </Text>

              <Text style={{ fontSize: 13, paddingLeft: 10 }}>Pago Mínimo</Text>

              <Text style={{ fontSize: 14, fontWeight: '600', color: 'black' }}>
                Monto
              </Text>

              <Text style={{ fontSize: 13, paddingLeft: 10 }}>$ 10,000.00</Text>
